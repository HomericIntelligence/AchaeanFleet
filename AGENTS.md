...
This repository follows the [`agents.md`](https://agents.md) convention for AI
coding agents. **This file (`AGENTS.md`) is the sole authoritative agent contract**
for Claude, Codex, Cursor, and any other agentic coding tool that operates in
this repo. If you are an AI agent, read this file first, then [`README.md`](./README.md)
for human-facing context, then [`CONTRIBUTING.md`](./CONTRIBUTING.md) for the
