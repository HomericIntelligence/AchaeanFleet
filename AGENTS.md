...
AI coding agents. This file is the canonical instruction file for Claude,
Codex, Cursor, and any other agentic coding tool that operates in this repo.
...
If you are an AI agent: read this file first, then
[`README.md`](./README.md) for human-facing context, then
[`CONTRIBUTING.md`](./CONTRIBUTING.md) for the contribution workflow.

## Project overview

AchaeanFleet is container infrastructure for the HomericIntelligence agent mesh.
